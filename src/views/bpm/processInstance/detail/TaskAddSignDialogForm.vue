...
// 消息弹窗
defineOptions({ name: 'BpmTaskUpdateAssigneeForm' }) ;// 提供 openModal 方法，用于打开弹窗

/** 提交表单 */
const emit = defineEmits(['success']) ;const message = useMessage()const dialogVisible = ref(false) // 弹窗的是否展示
