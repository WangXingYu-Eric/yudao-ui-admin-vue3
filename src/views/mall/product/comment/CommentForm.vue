<template>
  <Dialog v-model="dialogVisible" title="添加虚拟评论">
    ...
    >
      <el-form-item label="商品" prop="spuId">
        <div class="h-60px w-60px" @click="handleSelectSpu">
  ...
  <SkuTableSelect ref="skuTableSelectRef" :spu-id="spuData.id" @change="handleSkuChange" />
</template>
...
import type * as ProductSpuApi from '@/api/mall/product/spu'
