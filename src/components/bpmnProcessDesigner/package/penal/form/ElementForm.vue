<template>
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button">
      <XButton type="primary" pro-icon="ep:plus" title="添加字段" @click="openFieldForm(null, -1)" />
    </div>
    ...
    >
      ...
      <template v-if="formFieldForm.type === 'enum'">
        ...
        <el-table key="enum-table" :data="fieldEnumList" max-height="240" fit border>
      ...
      <el-table key="validation-table" :data="fieldConstraintsList" max-height="240" fit border>
        <el-table-column label="序号" width="50px" type="index" />
      ...
      <el-table key="property-table" :data="fieldPropertiesList" max-height="240" fit border>
        <el-table-column label="序号" width="50px" type="index" />
